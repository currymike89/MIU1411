...
-(void)request:(APSHTTPRequest *)request onLoad:(APSHTTPResponse *)response
{
	...
	if ([req cancelled]==NO)
	{
		...
		if (data == nil || [data length]==0)
		{
			...
			NSError *error = [NSError errorWithDomain:@"com.miu1411_curry_michael_ulitityapp2._miu1411_curry_michael_ulitityapp2.imageloader" code:1 userInfo:errorDetail];
