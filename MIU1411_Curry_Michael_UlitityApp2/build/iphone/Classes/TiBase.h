...
// in simulator we redefine to format for MIU1411_Curry_Michael_UlitityApp2 Developer console
...
{\
	NSString * exceptionName = [@"org.miu1411_curry_michael_ulitityapp2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.miu1411_curry_michael_ulitityapp2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMIU1411_Curry_Michael_UlitityApp2NativeItemNone = -1, 
	UIMIU1411_Curry_Michael_UlitityApp2NativeItemSpinner = -2,
	UIMIU1411_Curry_Michael_UlitityApp2NativeItemProgressBar = -3,
	
	UIMIU1411_Curry_Michael_UlitityApp2NativeItemSlider = -4,
	UIMIU1411_Curry_Michael_UlitityApp2NativeItemSwitch = -5,
	UIMIU1411_Curry_Michael_UlitityApp2NativeItemMultiButton = -6,
	UIMIU1411_Curry_Michael_UlitityApp2NativeItemSegmented = -7,
	
	UIMIU1411_Curry_Michael_UlitityApp2NativeItemTextView = -8,
	UIMIU1411_Curry_Michael_UlitityApp2NativeItemTextField = -9,
	UIMIU1411_Curry_Michael_UlitityApp2NativeItemSearchBar = -10,
	
	UIMIU1411_Curry_Michael_UlitityApp2NativeItemPicker = -11,
	UIMIU1411_Curry_Michael_UlitityApp2NativeItemDatePicker = -12,
	
	UIMIU1411_Curry_Michael_UlitityApp2NativeItemInfoLight = -13,
	UIMIU1411_Curry_Michael_UlitityApp2NativeItemInfoDark = -14,
	
	UIMIU1411_Curry_Michael_UlitityApp2NativeItemDisclosure = -15,
	
	UIMIU1411_Curry_Michael_UlitityApp2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all MIU1411_Curry_Michael_UlitityApp2 instances of
