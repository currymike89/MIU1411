...
/**
 Base class for all MIU1411_Curry_Michael_UlitityApp2 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the MIU1411_Curry_Michael_UlitityApp2 view hierarchy (such as wrapped iOS UIViews) was touched.
