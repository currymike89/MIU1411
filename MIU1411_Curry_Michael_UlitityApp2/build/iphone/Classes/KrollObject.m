...
//@interface MIU1411_Curry_Michael_UlitityApp2Object : NSObject
//@end

@interface MIU1411_Curry_Michael_UlitityApp2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MIU1411_Curry_Michael_UlitityApp2Object class]])
		{
			for (NSString *key in [[(MIU1411_Curry_Michael_UlitityApp2Object*)o modules] allKeys])
			{
