...
// in simulator we redefine to format for MIU1411_Curry_Michael_UlitityApp Developer console
...
{\
	NSString * exceptionName = [@"org.miu1411_curry_michael_ulitityapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.miu1411_curry_michael_ulitityapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMIU1411_Curry_Michael_UlitityAppNativeItemNone = -1, 
	UIMIU1411_Curry_Michael_UlitityAppNativeItemSpinner = -2,
	UIMIU1411_Curry_Michael_UlitityAppNativeItemProgressBar = -3,
	
	UIMIU1411_Curry_Michael_UlitityAppNativeItemSlider = -4,
	UIMIU1411_Curry_Michael_UlitityAppNativeItemSwitch = -5,
	UIMIU1411_Curry_Michael_UlitityAppNativeItemMultiButton = -6,
	UIMIU1411_Curry_Michael_UlitityAppNativeItemSegmented = -7,
	
	UIMIU1411_Curry_Michael_UlitityAppNativeItemTextView = -8,
	UIMIU1411_Curry_Michael_UlitityAppNativeItemTextField = -9,
	UIMIU1411_Curry_Michael_UlitityAppNativeItemSearchBar = -10,
	
	UIMIU1411_Curry_Michael_UlitityAppNativeItemPicker = -11,
	UIMIU1411_Curry_Michael_UlitityAppNativeItemDatePicker = -12,
	
	UIMIU1411_Curry_Michael_UlitityAppNativeItemInfoLight = -13,
	UIMIU1411_Curry_Michael_UlitityAppNativeItemInfoDark = -14,
	
	UIMIU1411_Curry_Michael_UlitityAppNativeItemDisclosure = -15,
	
	UIMIU1411_Curry_Michael_UlitityAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all MIU1411_Curry_Michael_UlitityApp instances of
