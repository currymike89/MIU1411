...
//@interface MIU1411_Curry_Michael_UlitityAppObject : NSObject
//@end

@interface MIU1411_Curry_Michael_UlitityAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MIU1411_Curry_Michael_UlitityAppObject class]])
		{
			for (NSString *key in [[(MIU1411_Curry_Michael_UlitityAppObject*)o modules] allKeys])
			{
