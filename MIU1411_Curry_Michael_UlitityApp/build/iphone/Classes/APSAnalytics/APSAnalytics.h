 ...
 * to send analytic data that can be viewed on the MIU1411_Curry_Michael_UlitityApp Dashboard.
 *
 * For information on getting started with MIU1411_Curry_Michael_UlitityApp Platform Services,
