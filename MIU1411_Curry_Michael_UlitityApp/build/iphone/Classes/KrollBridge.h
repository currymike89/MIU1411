...
@interface MIU1411_Curry_Michael_UlitityAppObject : KrollCoverageObject {
#else
@interface MIU1411_Curry_Michael_UlitityAppObject : KrollObject {
#endif
@private
...
extern NSString * MIU1411_Curry_Michael_UlitityApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	MIU1411_Curry_Michael_UlitityAppObject *_miu1411_curry_michael_ulitityapp;
    KrollObject* console;
	BOOL shutdown;
