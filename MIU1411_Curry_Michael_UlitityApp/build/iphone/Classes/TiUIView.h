...
/**
 Base class for all MIU1411_Curry_Michael_UlitityApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the MIU1411_Curry_Michael_UlitityApp view hierarchy (such as wrapped iOS UIViews) was touched.
