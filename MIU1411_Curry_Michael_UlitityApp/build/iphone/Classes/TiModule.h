...
/**
 The base class for all MIU1411_Curry_Michael_UlitityApp modules
 */
...
/**
 MIU1411_Curry_Michael_UlitityApp Platform calls this method on startup.
 */
-(void)startup;

/**
 MIU1411_Curry_Michael_UlitityApp Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 MIU1411_Curry_Michael_UlitityApp Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 MIU1411_Curry_Michael_UlitityApp Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 MIU1411_Curry_Michael_UlitityApp Platform calls this method on resume.
 @param sender The sender of the event.
 */
